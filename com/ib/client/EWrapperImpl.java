...
public class EWrapperImpl implements EWrapper {
	...
	public EWrapperImpl(String host, int port, int clientId) {
...
//		clientSocket.reqHistoricalData(4001, ContractSamples.test(), formatted,
//				"1 Y", "1 day", "TRADES", 1,
//				1, false, null);
//		clientSocket.reqHistoricalData(4002, ContractSamples.EuropeanStock(), formatted, "10 D", "1 min", "TRADES", 1, 1, false, null);
//		clientSocket.reqHistoricalData(4003, ContractSamples.USStockAtSmart(), formatted, "1 M", "1 day", "SCHEDULE", 1, 1, false, null);
//		Thread.sleep(2000);
		/*** Canceling historical data requests ***/
//		clientSocket.cancelHistoricalData(4001);
//		clientSocket.cancelHistoricalData(4002);
//		clientSocket.cancelHistoricalData(4003);
	}
	...
	@Override
	public void updatePortfolio(Contract contract, Decimal position, double marketPrice, double marketValue, double averageCost, double unrealizedPNL,
