...
public class ApiController implements EWrapper {
	...
	public void connect( String host, int port, int clientId, String connectionOpts ) throws Exception {
	...
	public interface IHistoricalDataHandler {
		void historicalData(com.ib.client.Bar bar);
...
//		m_inLogger.log("HistoricalData:  " + EWrapperMsgGenerator.historicalData(reqId, bar.time(), bar.open(), bar.high(), bar.low(), bar.close(), bar.volume(), bar.count(), bar.wap()));
//		recEOM();
	}
