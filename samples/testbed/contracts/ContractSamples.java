...
public class ContractSamples {
	...
	public static Contract SPXIndex() {
		//! [cashcontract]
		Contract contract = new Contract();
		contract.symbol("SPX");
	...
	public static Contract USOptionContract() {
		...
		contract.currency("USD");
		contract.exchange("SMART");
		contract.lastTradeDateOrContractMonth("20230719");
		contract.strike(615);
		contract.right("C");
		contract.multiplier("100");
		return contract;
	...
	public static Contract OptionAtBOX() {
		...
		contract.currency("USD");
		contract.exchange("ARCA");
//		contract.lastTradeDateOrContractMonth("20230819");
		contract.right("C");
		contract.strike(119);
//		contract.multiplier("100");
		//! [optcontract]
	...
	public static Contract SPX() {
		...
		contract.currency("USD");
		contract.exchange("CBOE");
		contract.lastTradeDateOrContractMonth("20231017");
		contract.right("P");
		contract.strike(4300);
		contract.multiplier("100");
		//! [optcontract]
		return contract;
	}
